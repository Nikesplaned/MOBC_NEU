    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                if (marker.getTag() != null && marker.getTag().equals("user")) {
                    Toast.makeText(MapsActivity.this, "Marker löschen: " + marker.getTitle(), Toast.LENGTH_SHORT).show();
                    marker.remove();
        ...
        mMap.setOnCameraIdleListener(new GoogleMap.OnCameraIdleListener() {
            ...
            public void onCameraIdle() {
                ...
                Toast.makeText(MapsActivity.this, "Kameramittelpunkt: " + center.latitude + ", " + center.longitude, Toast.LENGTH_SHORT).show();
            }
        });
